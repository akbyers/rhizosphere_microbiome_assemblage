...
prevalence.75_ITS
saveRDS(prevalence.75_ITS, "ITS_Pime_Prevalence_75.rds")

prevalence.80_16S = prevalences_16S$`80`
prevalence.80_16S
saveRDS(prevalence.80_16S, "16S_Pime_Prevalence_80.rds")
```
...
PlantID_corplot_16S <- ggplot(data = plantID_cormat.m2, aes(x=Var1, y=Var2, fill=value)) + 
 ...
 theme(axis.text.x = element_text(angle = 90, vjust = 1, 
    ...
    size = 8, hjust = 1))+
 coord_fixed()
tiff("~/Xioben data/Alexa_TRM_analysis/April_2024/Figure_5.tiff", units="in", width=10, height=10, res=300)
PlantID_corplot_16S
```
